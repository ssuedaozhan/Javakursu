...
public class FabrikaMain {
    public static void main(String[] args) {
        ...
        for(Vehicle v: arabalar){ //
            System.out.println("---------------------------");
            System.out.println(v.getClass().getSimpleName()); // class ın adını verir , tesla ,bus..
            System.out.println("---------------------------");

            System.out.println("v.getModel() = " + v.getModel());
            System.out.println("v.getEngine() = " + v.getEngine());

            if (v instanceof TeslaCar) { // v teslacar tipindeyse ozaman bana bunlari cagir ,
                // ifin icindekesini okuyabulmesi icin
