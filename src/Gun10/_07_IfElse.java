...
public class _07_IfElse {
    public static void main(String[] args) {
        ...
        String sayilar=oku.nextLine(); //string olarak tanittiki boslugu bulalim , sonrada ceviri yapilacak.
        ...
        int sayi1= Integer.parseInt(strSayi1); // 45 parse: rakam haline getirmek icin
        int sayi2= Integer.parseInt(strSayi2); // 67 rakam haline getirmek icin
