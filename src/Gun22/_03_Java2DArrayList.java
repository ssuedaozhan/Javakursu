...
public class _03_Java2DArrayList {
    public static void main(String[] args) {
        ...
        System.out.println("***********************"); // araya karismasin die
        Scanner oku = new Scanner(System.in); // kullanicidan aldik
        System.out.print("Seciminiz  (0-Mat, 1-Fiz, 2-Kim) =");
        int dersNo = oku.nextInt();
        // metodun returnu yok yani drek olarak yazdiracagiz .


        // bu metpdu yazdirmasi icin : notlari lisretisini ihtiyacimi zvar , birde ders no : yani hangi dersten alacagi
...
// notlar listesinin tipi : listelerin listesi
    // ders no tipi int oldugu icin int + ders no seklinde yapiyoruz .
